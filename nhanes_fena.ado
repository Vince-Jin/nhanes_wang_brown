					...
					foreach i of numlist `ys_2' {
						...
						if (!(inrange(`i', 2017, 2020)) | (inrange(`i', 2017, 2020) & `prepan_counter' == 0)) {
							...
							if (`ds' == 5) {
								...
								// 1999
								local DATA1 ALQ DIQ KIQ   BPQ PAQ SMQ MCQ BPQ SSQ CIQMDEP CIQGAD CIQPANIC RHQ HUQ
								// 2001 - 2004
								local DATA2 ALQ DIQ KIQ_U BPQ PAQ SMQ MCQ BPQ SSQ CIQDEP CIQGAD CIQPAN RHQ HUQ
								// 2005 - 2006
								local DATA3 ALQ DIQ KIQ_U BPQ PAQ SMQ MCQ BPQ SSQ DPQ RHQ HUQ
								// 2007 - 2009
								local DATA3 ALQ DIQ KIQ_U BPQ PAQ SMQ MCQ BPQ SSQ DPQ HUQ
								// 2009+
								local DATA4 ALQ DIQ KIQ_U BPQ PAQ SMQ MCQ BPQ DPQ HUQ
								
								if (`i' == 1999) {
									local qs_name `DATA1'
								}
								else if ((inrange(`i', 2001,2004))) { // leave as 9999 for future datasets
									local qs_name `DATA2'
								}
								else if ((inrange(`i', 2005,2008))) { // leave as 9999 for future datasets
									local qs_name `DATA3'
								}
								else if ((inrange(`i', 2009,9999))) { // leave as 9999 for future datasets
									local qs_name `DATA4'
								}
